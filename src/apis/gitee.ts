...
export const apis: Record<string, ApiOptions> = {
  ...
  watchers: {
    ...
    rules: {
      status: {
        selector:
          ".git-project-header-actions .watch-container .action-social-count",
  ...
  stars: {
    ...
    rules: {
      status: {
        selector:
          ".git-project-header-actions .star-container .action-social-count",
        handlers: [{ method: "text" }, { method: "trim" }],
      },
    },
  },
  forks: {
    ...
    rules: {
      status: {
        selector:
          ".git-project-header-actions .fork-container .action-social-count",
        handlers: [{ method: "text" }, { method: "trim" }],
      },
    },
  },
  ...
  releases: {
    ...
    rules: {
      status: {
        selector:
          "#project-wrapper .project__right-side .release .header .text-muted",
        handlers: [
          { method: "text" },
          { method: "replace", args: ["\\D", ""] },
        ],
  ...
  tags: {
    ...
    rules: {
      status: {
        selector:
          "#git-project-bread .branches-tags .item:nth-child(2) .button",
        handlers: [
          { method: "text" },
          { method: "replace", args: ["\\D", ""] },
        ],
  ...
  license: {
    ...
    rules: {
      status: {
        selector:
          "#project-wrapper .project__right-side .intro .content .intro-list #license-popup",
        handlers: [{ method: "text" }],
      },
    },
  },
