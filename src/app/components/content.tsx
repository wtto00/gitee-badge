...
export default function Content(props: Props) {
  let content = props.html.replace(/https:\/\/gitee-badge\.vercel\.app/g, window.location.origin);
  content = content.replace(/https%3A%2F%2Fgitee-badge.vercel.app/g, encodeURIComponent(window.location.origin));

  return <div className={props.className} dangerouslySetInnerHTML={{ __html: content }}></div>;
}

export function Loading(props: DynamicOptionsLoadingProps) {
